            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-header font-weight-bold">
                        Thêm nội dung liên quan đánh giá
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php if ($getListCat > 0) { ?>
                                    <?php foreach ($getListCat as $item) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="?mod=price&action=updateCat&id=<?php echo $item['id'] ?>">
                                                    <button class="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button>
                                                </a>
                                                <a href="?mod=price&action=deleteCat&id=<?php echo $item['id'] ?>" onclick="deleteAlert()">
                                ...
                                <?php }else{ ?>
                                        <tr>
                                            <td scope="col-5">Hiện đang không có danh mục nội dung dịch vụ nào ?</td>
                                        </tr>
                                    <?php } ?>
                            </tbody>
                        </table>
