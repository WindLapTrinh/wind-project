   ...
   <footer id="footer" class="footer-area">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-links">
                            <li>
                                <i class="fal fa-angle-right"></i>
                                <a href="https://www.instagram.com/windlaptrinh/?hl=en">Instagram</a>
                            </li>
                            <li>
                                <i class="fal fa-angle-right"></i>
                                <a href="https://www.facebook.com/profile.php?id=100083795057694">Facebook</a>
                            </li>
                            <li>
                                <i class="fal fa-angle-right"></i>
        ...
        <div class="copy-right-area text-center">
            <div class="container">
                <span>
                    @Wind Lập Trình thuộc SLK Solutions
                </span>
            </div>
        </div>
    </footer>
